...
public:
  ...
  inline bool getC3Mdps();
  inline void setC3Mdps(bool value);
...
inline bool CarParams::Reader::getC3Mdps() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<1004>() * ::capnp::ELEMENTS);
}

inline bool CarParams::Builder::getC3Mdps() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<1004>() * ::capnp::ELEMENTS);
}
inline void CarParams::Builder::setC3Mdps(bool value) {
  _builder.setDataField<bool>(
      ::capnp::bounded<1004>() * ::capnp::ELEMENTS, value);
}
